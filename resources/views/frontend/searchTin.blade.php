...
<div class="container-fluid"style="margin-top: -20px;" >
	<div class="row">
        <div class="breadcrumb-header" style="background-image:url('{{url('public')}}/assets/images/banner/shop-baner.jpg')">
            <div class="container">
                <h1 class="text-light chu">Blog Standard</h1>
			...
			<div class="col-md-4">
				<div class="blogs-filter border-md">
                    <h5><b>SEARCH</b></h5>
                       ...
                       <form action="{{route('tktin')}}" method="get" class="navbar-form " role="search"> 
				           ...
				           <button style="height: 30px;" type="submit"class="fas fa-search"></button>
				       </form>
                </div>
                ...
                <div class="blogs-filter border-md" style="height: 900px;">
	                ...
	                <div class="row">
	                    ...
	                    <div class="col-md-6">
	                    	<p>{{$value->title}}</p>
	                    	<li id="content"><a href=""id=""class="glyphicon glyphicon-sound-dolby">{{$value->created_at}}</a></li>
	                    </div>
	                </div>
	                <hr>
	                @endforeach()
