tinymce.init({
    ...
    external_filemanager_path: "http://localhost/MARCHO/filemanager/",
    external_plugins: {"filemanager" : "http://localhost/MARCHO/filemanager/plugin.min.js"},
...
tinymce.init({
	...
	toolbar1: "undo redo bold italic underline | alignleft aligncenter alignright alignjustify bullist numlist outdent indent blockquote link unlink anchor | preview | forecolor backcolor image fullscreen code",
	image_advtab: true,
	menubar: false,
